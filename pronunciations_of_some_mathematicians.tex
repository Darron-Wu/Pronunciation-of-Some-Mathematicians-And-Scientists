...
% This is a note of pronunciations of almost all mathematicians and some
% physicists that I have heard in the university. I say "almost" because only
% those who can be found on Wikipedia are included. Since ctex and IPA packages
% are not compatible(even in 2022!), you can only see the Chinese translations
% (if available) in this tex file, not in the generated pdf. If you have a
% solution to this problem, please create an issue in the repository on github
% at
...
% likely to be pronounced (and the language from which the Chinese translations
% should be given). It is for reference only and should not be confused with
% "nationality".
